...
namespace Yemek_Sepeti_Temel_KIRCI
{
    ...
    public partial class MusteriGirisEkrani : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) // KAYDOL butonu
        {
        ...
        private void button2_Click(object sender, EventArgs e) // üye ol
        {
            ...
            temel.ConnectionString = "Data Source = JOKER ; database = YemekSepetiTemelKırcı ; integrated security=true ";
            temel.Open();
            string komut = "insert into Müsteri(MüsteriAd , MüsteriSoyad , MüsteriKullanıcıAdı , MüsteriŞifre) values('" + textBox4.Text + "' , '" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "')";
